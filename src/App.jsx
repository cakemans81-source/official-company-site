    ...
    <div className="app-container">
      ...
      <header className="header">
        <div className="container nav">
          <div className="logo" style={{ color: '#fff', fontSize: '1.8rem', fontWeight: '900' }}>
            IRU<span style={{ color: 'var(--primary)', marginLeft: '2px' }}>.</span>
          </div>
          <nav className="nav-links">
            <a href="#about" className="nav-link">회사소개</a>
            <a href="#tech" className="nav-link">핵심기술</a>
            <a href="#portfolio" className="nav-link">실적현황</a>
            <a href="#infra" className="nav-link">제조 인프라</a>
      ...
      <section className="hero">
        <div className="container">
          ...
          <h1>초대형 기술의 완성,<br /><span style={{ color: 'var(--primary)', background: 'var(--gradient-primary)', WebkitBackgroundClip: 'text', backgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>실감형 Mockup 전문가</span></h1>
          <p>
      ...
      <section className="container" style={{ padding: '40px 0 100px' }}>
        ...
        <div className="service-grid">
          <div className="service-card">
            ...
            <ChevronRight style={{ marginTop: '1.5rem', color: 'var(--primary)' }} />
          </div>
          <div className="service-card">
      ...
      {/* Partners Section */}
      <section className="container" style={{ padding: '80px 0', borderTop: '1px solid var(--border)' }}>
        ...
        <div className="partner-grid">
          {['현대자동차그룹', '기아자동차', '현대트랜시스', '현대모비스', 'INOCEAN', '코오롱글로텍', '대원산업', '대유에이텍'].map((name, i) => (
            <div key={i} className="partner-item" style={{ background: 'rgba(255,255,255,0.02)', border: '1px solid var(--border)' }}>
              {name}
            </div>
          ))}
        </div>
      ...
      <section id="about" className="container" style={{ padding: '100px 0' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'center' }}>
          <div>
            ...
            <h2 style={{ fontSize: '2.5rem', marginTop: '1rem', marginBottom: '1.5rem' }}>고객의 Needs를 이해하고<br />최상의 제품을 만드는 것</h2>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
              <div style={{ borderLeft: '3px solid var(--primary)', paddingLeft: '1.5rem' }}>
                <h4 style={{ color: '#fff', marginBottom: '0.5rem' }}>품질 제일주의</h4>
                <p style={{ fontSize: '0.85rem', color: '#64748b' }}>미크론 단위의 오차도 허용치 않는 정밀함</p>
              </div>
              <div style={{ borderLeft: '3px solid var(--accent)', paddingLeft: '1.5rem' }}>
                <h4 style={{ color: '#fff', marginBottom: '0.5rem' }}>사용자 중심</h4>
                <p style={{ fontSize: '0.85rem', color: '#64748b' }}>실제 사용 환경을 고려한 인체공학적 설계</p>
              </div>
            </div>
          </div>
          <div className="location-card" style={{ padding: '3rem', border: '1px solid rgba(99, 102, 241, 0.2)' }}>
            <h3 style={{ marginBottom: '2rem', display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
              <Building2 color="var(--primary)" /> 기업 일반 현황
            </h3>
            <div style={{ display: 'grid', gap: '1.5rem' }}>
              <div>
                <span style={{ color: '#64748b', fontSize: '0.8rem' }}>대표이사</span>
                <p style={{ fontWeight: '600' }}>이광수</p>
              </div>
              <div>
                <span style={{ color: '#64748b', fontSize: '0.8rem' }}>소재지</span>
                <p style={{ fontWeight: '600' }}>본사: 화성시 팔탄면 밤뒤길 9 (A, B동)<br />2공장: 팔탄면 원골길 51</p>
              </div>
              <div>
                <span style={{ color: '#64748b', fontSize: '0.8rem' }}>주요 사업</span>
                <p style={{ fontWeight: '600' }}>자동차 목업 및 시트 제조, 전시용 목업, 컨셉 디자인 모델</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Portfolio Section */}
      <section id="portfolio" className="container" style={{ padding: '100px 0' }}>
        <div className="section-title">
          <h2>프로젝트 실적</h2>
      ...
      {/* Infra Section */}
      <section id="infra" style={{ background: 'rgba(255,255,255,0.02)', padding: '100px 0' }}>
        <div className="container">
          <div className="section-title">
            <h2>주요 제조 인프라</h2>
          ...
          <div className="equipment-list">
            <div className="equipment-item">
              <div className="eq-img"><Pipette size={40} /></div>
            ...
            <div className="equipment-item">
              <div className="eq-img"><Settings size={40} /></div>
              <div className="eq-content">
                <h4>고성능 CNC (DNM750LII) - 3대 보유</h4>
                <p>시트 폼 패드, 스티로폼, ABS, 아크릴 등 다양한 하드물 가공을 위한 고성능 밀링 센터를 운영합니다.</p>
              </div>
            </div>
            <div className="equipment-item">
              <div className="eq-img"><Printer size={40} /></div>
              <div className="eq-content">
                <h4>정밀 3D 프린팅 센터</h4>
            ...
            <div className="equipment-item">
              <div className="eq-img"><Wrench size={40} /></div>
              <div className="eq-content">
                <h4>공업용 미싱 & 용접 설비</h4>
      ...
      {/* CTA Banner Section */}
      <section style={{ background: 'var(--gradient-primary)', padding: '100px 0', margin: '40px 0' }}>
        <div className="container" style={{ textAlign: 'center' }}>
          <h2 style={{ fontSize: '3rem', marginBottom: '1.5rem', color: '#fff', fontWeight: '900' }}>압도적인 기술력을 지금 경험하세요</h2>
          <p style={{ color: 'rgba(255,255,255,0.9)', fontSize: '1.4rem', marginBottom: '3rem', fontWeight: '500' }}>
            (주)이루의 시제작 솔루션은 귀사의 비전을 현실로 만드는 가장 빠른 길입니다.
          </p>
          <a href="#contact" className="btn" style={{ background: '#fff', color: 'var(--primary)', padding: '1.2rem 3.5rem', fontSize: '1.1rem', borderRadius: '100px', boxShadow: '0 20px 40px rgba(0,0,0,0.2)' }}>
            견격 및 비즈니스 문의하기
          </a>
        </div>
      </section>
      ...
      <section id="cert" className="container" style={{ padding: '100px 0' }}>
        <div className="section-title">
          <h2>품질 및 기술 인증</h2>
        </div>
      ...
      {/* Footer */}
      <footer id="contact" style={{ background: '#0a0f1d', padding: '80px 0', borderTop: '1px solid var(--border)' }}>
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '4rem' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.8rem' }}>
              <h4 style={{ color: '#fff', marginBottom: '0.5rem' }}>Contact Info</h4>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.8rem', color: '#64748b', fontSize: '0.9rem' }}>
                <Phone size={16} /> 이사 성경욱 (영업팀)
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.8rem', color: '#64748b', fontSize: '1rem', fontWeight: '700' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.8rem' }}>
              <h4 style={{ color: '#fff', marginBottom: '0.5rem' }}>Business Hours</h4>
              <span style={{ color: '#64748b', fontSize: '0.9rem' }}>평일 08:30 - 17:30</span>
              <span style={{ color: '#64748b', fontSize: '0.9rem' }}>토요일 08:30 - 12:00</span>
              <span style={{ color: '#64748b', fontSize: '0.9rem' }}>공휴일 및 일요일 휴무</span>
            </div>
          </div>
          <div style={{ marginTop: '4rem', paddingTop: '2rem', borderTop: '1px solid rgba(255,255,255,0.05)', textAlign: 'center', color: '#475569', fontSize: '0.8rem' }}>
