...
const TRANSLATIONS = {
  ko: {
    ...
    'contact-tuning-btn': '시트 커스텀 문의',
    'inquiry-heading': '견적 및 프로젝트 문의',
    'inquiry-desc': '(주)이루는 대표님의 비즈니스를 위한 최상의 목업을 제안합니다.',
    'inquiry-tuning-title': '자동차 시트 커스텀 전용 상담',
    'inquiry-tuning-desc': '최고급 나파가죽 시트 교체 & 알칸타라 실내 커스텀',
    'inquiry-tuning-link': '시트 커스텀 전용 페이지 바로가기 →',
  ...
  en: {
    ...
    'nav-technology': 'Process',
    'nav-tuning': 'Seat Custom',
    'nav-inquiry': 'Inquiry',
    'hero-tagline': "LET'S MAKE IT HAPPEN — SINCE 2022",
    ...
    'contact-tuning-btn': 'Seat Custom Inquiry',
    'inquiry-heading': 'Project & Quote Inquiry',
    'inquiry-desc': 'IRU will propose the best mockup solution for your business.',
    'inquiry-tuning-title': 'Seat Custom Consultation',
    'inquiry-tuning-desc': 'Premium Nappa Leather Seat & Alcantara Interior Custom',
    'inquiry-tuning-link': 'Go to Seat Custom Page →',
